    ...
    if (existingSettings) {
      ...
      settings = await prisma.platformSettings.update({
        ...
        data: {
          ...
          tokenLoginApiUrl: body.tokenLoginApiUrl,
          tokenLoginMethod: body.tokenLoginMethod,
          tokenLoginRequestHeaders: body.tokenLoginRequestHeaders,
          tokenLoginRequestBody: body.tokenLoginRequestBody,
          tokenResponsePath: body.tokenResponsePath,
