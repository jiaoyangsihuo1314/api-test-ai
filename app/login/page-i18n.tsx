        ...
        <div className="max-w-xl">
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h3 className="text-base font-semibold text-white mb-1">{t('feature1Title')}</h3>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h3 className="text-base font-semibold text-white mb-1">{t('feature2Title')}</h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  {t('feature2Desc')}
                </p>
              </div>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h3 className="text-base font-semibold text-white mb-1">{t('feature3Title')}</h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  {t('feature3Desc')}
                </p>
              </div>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h3 className="text-base font-semibold text-white mb-1">{t('feature4Title')}</h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  {t('feature4Desc')}
                </p>
              </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="grid grid-cols-3 gap-8">
              <div>
                ...
                <div className="text-sm text-gray-400 mt-1">{t('stat1')}</div>
              </div>
              <div>
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  99%
                </div>
                <div className="text-sm text-gray-400 mt-1">{t('stat2')}</div>
              </div>
              <div>
                <div className="text-3xl font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
                  5x
                </div>
                <div className="text-sm text-gray-400 mt-1">{t('stat3')}</div>
              </div>
            </div>
          </div>
        </div>
